...
import py.com.fuentepy.appfinanzasBackend.sevice.TipoCobroService;
...
//            }
    ...
    public ResponseEntity<?> update(@Valid @RequestBody TipoCobro tipoCobro, BindingResult result, @PathVariable Long id) {
